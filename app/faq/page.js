      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">How do I get to Retford by train?</h3>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">How do I get to Retford by car?</h3>
                <p className="text-gray-700 mb-3">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Is there a bus service to Retford?</h3>
                <p className="text-gray-700">
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">What are the top attractions in Retford?</h3>
                <p className="text-gray-700 mb-3">
                  The top attractions include:
                </p>
                <ul className="list-disc pl-6 text-gray-700 space-y-2">
                  <li><strong>St Swithun&apos;s Church</strong> - A landmark parish church in the town centre with impressive architecture</li>
                  <li><strong>Bassetlaw Museum</strong> - Local history collections and exhibitions about Retford and the wider district</li>
                  <li><strong>Kings&apos; Park</strong> - A central blue space for walks, events, and family time</li>
                  <li><strong>Idle Valley Nature Reserve</strong> - A nearby spot for wildlife, walking, and birdwatching</li>
                  <li><strong>Chesterfield Canal</strong> - Offering pleasant towpath walks through Retford</li>
                  <li><strong>Local markets</strong> - Traditional markets operating several days a week in the town centre</li>
                </ul>
              </div>

              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Is Retford worth visiting for a day trip?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">What outdoor activities are available near Retford?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">What countryside is near Retford?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Are there free outdoor places to visit near Retford?</h3>
                <p className="text-gray-700">
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Where can I stay in Retford?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Are there restaurants and cafes in Retford?</h3>
                <p className="text-gray-700">
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">What shopping facilities are available in Retford?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">When do the markets operate in Retford?</h3>
                <p className="text-gray-700">
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">How old is Retford?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Can I visit St Swithun&apos;s Church?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">What is Bassetlaw Museum?</h3>
                <p className="text-gray-700">
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Is Retford accessible for wheelchair users?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Is there a tourist information centre in Retford?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">What is the best time of year to visit Retford?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">How easy is it to reach countryside areas from Retford?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Are dogs allowed in Retford's parks and attractions?</h3>
                <p className="text-gray-700">
          ...
          {/* Contact */}
          <section className="bg-blue-50 border border-blue-200 rounded-lg p-8 mt-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Still Have Questions?</h2>
            <p className="text-gray-700 mb-4">
              If you couldn't find the answer you were looking for, please don't hesitate to get in touch. We're here to help you make the most of your visit to Retford.
            </p>
            <a 
              href="/contact" 
